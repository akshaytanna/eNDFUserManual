...
The outcome of the NDF can be decided by the user by selecting from a drop down menu. Additional information including a justification and an NDF expiry can also be set.
```{r echo=FALSE, out.width='100%',fig.align='center'}
