...
knitr::include_graphics('images/Help context.png')
```
...
```{r echo=FALSE, out.width='100%',fig.align='center'}
knitr::include_graphics('images/Referencedata.png')
```
...
```{r echo=FALSE, out.width='100%',fig.align='center'}
knitr::include_graphics('images/Dropdown.png')
```
...
```{r echo=FALSE, out.width='100%',fig.align='center'}
knitr::include_graphics('images/Textentry.png')
```
