...
The workflow for the e-NDF is illustrated below. United.

```{asis, echo=!knitr::is_latex_output()}
<p style="text-align: center;"><a href="https://www.blueresources.org"><img src="images/eNDF_logo.png" alt="logo" /></a></p>
```
