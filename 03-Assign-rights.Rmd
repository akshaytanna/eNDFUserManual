...
knitr::include_graphics('images/Accessrightsmulti1.png')
```
...
```{r echo=FALSE, out.width='80%',fig.align='center'}
knitr::include_graphics('images/Accessrightsmulti2.png')
```
...
```{r echo=FALSE, out.width='80%',fig.align='center'}
knitr::include_graphics('images/Accessrightsmulti3.png')
```

# Access to the specific parts for users {#singleuser}
...
```{r echo=FALSE, out.width='80%',fig.align='center'}
knitr::include_graphics('images/Singleuser1.png')
```
...
```{r echo=FALSE, out.width='80%',fig.align='center'}
knitr::include_graphics('images/Singleuser2.png')
```
...
```{r echo=FALSE, out.width='80%',fig.align='center'}
knitr::include_graphics('images/Singleuser3.png')
```
...
## Confirm access assignment
```{r echo=FALSE, out.width='80%',fig.align='center'}
knitr::include_graphics('images/Singleuser4.png')
```